...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('admin/assets') }}/" data-template="vertical-menu-template">
    <head>
        ...
        <!-- Core CSS -->
        <link rel="stylesheet" href="{{ asset('admin/assets/vendor/css/rtl/core.min.css') }}" class="template-customizer-core-css" />
        ...
        <!-- Helpers -->
        <script src="{{ asset('admin/assets/vendor/js/helpers.min.js') }}"></script>
