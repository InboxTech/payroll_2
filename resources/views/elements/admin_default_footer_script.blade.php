    ...
    <script src="{{ asset('admin/assets/vendor/libs/apex-charts/apexcharts.min.js') }}"></script>
    <script src="{{ asset('admin/assets/vendor/libs/datatables-bs5/datatables-bootstrap5.min.js') }}"></script>
