    ...
    @section('content')
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <h4 class="py-lg-3 mb-lg-4"><span class="text-muted fw-light">Dashboard /</span> Department</h4>
                ...
                <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
                    <div class="modal-content p-3 p-md-5">
                        <div class="modal-body">
                            ...
                            <form action="{{ route('department.store') }}" method="POST" class="row g-3 FormValidate" autocomplete="off">
                                @csrf
                                <div class="col-12">
                                    <label class="form-label w-100" for="department-name">Department Name <span class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control" data-rule-required="true" data-msg-required="Please Enter Department Name"/>
                                </div>
            ...
            <div class="card">
                <div class="card-datatable text-nowrap">
                    <table class="data-table table text-center table-responsive text-nowrap" id="Department">
                        <thead>
                            <tr>
