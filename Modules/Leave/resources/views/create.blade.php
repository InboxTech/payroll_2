                        ...
                        <div class="card-body">
                            <form action="{{ route('leave.store') }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="leave_type_name" value="{{ old('leave_type_name') }}"/>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control only_numbers" name="number_of_leaves" value="{{ old('number_of_leaves') }}"/>
