            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <h4 class="py-3 mb-4">
                    <span class="text-muted fw-light">
                        ...
                        <a href="{{ route('hr.edit', $result->id) }}" class="text-reset">Leave Edit</a> /
                    </span> Edit
                </h4>
            </div>
            <div class="row">
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form class="jsFormValidate" action="{{ route('hr.updateleave', $result->id) }}" method="post">
                                @csrf 
                                @method('put')
                                <div class="row">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="{{ route('hr.edit', $result->id) }}" class="btn btn-label-secondary waves-effect">Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
